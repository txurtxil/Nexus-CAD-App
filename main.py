...
def get_sys_info():
    ...
    if HAS_PSUTIL:
        ...
        try:
            # Lectura nativa en Termux/Android sin dependencias
...
def main(page: ft.Page):
    try:
        ...
        status = ft.Text("NEXUS v18.2 PRO | Sistema Estable", color="#00E5FF", weight="bold")
        ...
        # =========================================================
        # MEJORA V18: MOTOR DE TEXTO AVANZADO Y SEGURO PARA ANDROID
        # =========================================================
        ...
        # Asignación segura de eventos POST-creación (Evita el TypeError Crash en Termux/Pydroid)
        ...
        col_texto = ft.Column([
            ...
            inst("GH define el grosor de la placa. 'Grabado' invierte la operación booleana (texto hundido)."), 
        ...
        # === HERRAMIENTAS (RESTO DE LA V17.7 INTACTA) ===
        ...
        def generate_param_code():
            ...
            if h == "custom":
                ...
                # Configuracion de Altura Z de las letras según sea Relieve o Grabado
...
"""
                ...
                # Lógica Booleana Definitiva
                # FIX: Si NO hay base (Solo texto/Texto Libre), no podemos hacer union ni subtract con la nada.
                code += "  if(baseObj !== null) {\n"
                if grabado:
                    code += "      return baseObj.subtract(pText);\n  } else {\n"
                else:
                    code += "      return baseObj.union(pText);\n  } else {\n"
            ...
            while True:
                ...
                try:
                    if main_container.content == view_visor:
                        ...
                        # Actualizamos solo el panel para no saturar Flet
                        hw_panel.update()
                except: pass
        ...
        # =========================================================
        # PESTAÑA DB: GESTOR DE ARCHIVOS Y RENOMBRADO INLINE (V17.7)
        # =========================================================
        ...
        view_archivos = ft.Column([
            ...
            ft.Divider(color="#30363D"),
            ft.Text("Archivos Locales", color="#00E5FF", weight="bold"),
            rename_panel,
            file_list
        ], expand=True)
